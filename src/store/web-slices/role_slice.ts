...
export const postScoreToAdd = createAsyncThunk(
  "postScoreToAdd",
  async (scoreAddUser: ScoreAddUserType) => {
...
export const getScoreToAddUsers = createAsyncThunk(
  "getScoreToAddUsers",
  async () => {
    const response: Promise<ScoreAddUserType> = fetch(
      API_PATH + "game/gameScore",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
