...
const Statistics : React.FC = () => {
    ...
    return (
        <div className={styles.boxWrapStatistics}>
            <div className={styles.textWrap}><p className={styles.text}>Лучший игрок:</p>
                <p className={styles.user}>{winner}</p>
            </div>
            <div className={styles.textWrap}><p className={styles.text}>Лучше всех рисовал:</p>
                <p className={styles.user}>{mostSuccessDrawing}</p>
            </div>
            <div className={styles.textWrap}><p className={styles.text}>Лучше всех угадывал:</p>
